...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="flex w-full max-w-4xl bg-white rounded-lg shadow-xl overflow-hidden">
        ...
        <div class="w-1/2 p-10 flex flex-col justify-center">
            <h2 class="text-3xl font-bold mb-6 text-center text-gray-800 tracking-wide">CREATE ACCOUNT</h2>
            ...
            <p class="mt-4 text-center text-sm text-gray-600">
                ...
                <a href="<?= site_url('auth/login') ?>" class="text-sky-600 font-semibold hover:underline">Go back to Log In</a>
            </p>
        </div>
    </div>
